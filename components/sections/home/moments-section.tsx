...
const moments: Moment[] = [
  {
    src:
      "/media/moments/moment-01.jpg",
    alt:
      "La Foresta crowd atmosphere",
    caption:
      "Collective energy",
    className:
  ...
  {
    src:
      "/media/moments/moment-02.jpg",
    alt:
      "La Foresta lighting detail",
    caption:
  ...
  {
    src:
      "/media/moments/moment-03.jpg",
    alt:
      "La Foresta artist performance",
    caption:
      "Sound in motion",
    className:
      "md:col-span-5 aspect-[4/5]",
  ...
  {
    src:
      "/media/moments/moment-04.jpg",
    alt:
      "La Foresta immersive environment",
    caption:
  ...
  {
    src:
      "/media/moments/moment-05.jpg",
    alt:
      "La Foresta night experience",
    caption:
      "After dark",
    className:
      ...
      <div className="lf-container relative z-10">
        ...
        <div className="mt-14 grid gap-10 lg:grid-cols-[1.3fr_0.7fr] lg:items-end">
          <div className="overflow-hidden">
            <h2
              ref={headingRef}
              className="font-display text-[clamp(3.8rem,12vw,10rem)] font-medium leading-[0.8] tracking-[-0.07em]"
            >
              Built to
              <br />
              be felt.
          ...
          >
            ...
            sound and movement become
            part of something larger.
            Every La Foresta experience
            is designed to stay with you
            after the music ends.
          </p>
        </div>

        <div className="mt-14 grid grid-cols-1 gap-5 sm:mt-20 md:grid-cols-12 md:gap-6">
          {moments.map(
            (moment, index) => (
              <div
                key={moment.src}
        ...
        <div className="mt-8 flex items-center justify-between gap-6 border-t border-white/10 pt-6">
          ...
          <p className="font-technical text-right text-[9px] uppercase tracking-[0.2em] text-electric">
