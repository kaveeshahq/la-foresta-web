    ...
    >
      ...
      <div className="lf-container relative z-10">
        ...
        <div className="mt-14 overflow-hidden">
          <h2
            ref={headingRef}
            className="font-display max-w-6xl text-[clamp(3.7rem,12vw,10rem)] font-medium leading-[0.8] tracking-[-0.07em]"
          >
            Sound without
            <br />
            borders.
        ...
        <div className="mt-10 flex justify-start lg:justify-end">
          <p className="max-w-md text-base leading-8 text-muted-foreground">
            A carefully selected mix of
            international and local artists
            shaping the sound of the next
            La Foresta experience.
          </p>
        </div>
          ...
          {artists.map(
            (artist, index) => (
              <div
                ...
                className="group relative grid cursor-default grid-cols-[42px_1fr] items-center gap-3 border-b border-white/10 py-6 transition-colors duration-300 sm:grid-cols-[50px_1fr] sm:gap-4 sm:py-7 md:grid-cols-[80px_1fr_180px] md:py-9"
              >
                <span className="font-technical text-[9px] text-electric">
                  {artist.number}
                </span>

                <h3 className="font-display text-[clamp(2.1rem,7vw,5.7rem)] font-medium leading-none tracking-[-0.055em] text-foreground transition-all duration-500 group-hover:translate-x-2 group-hover:text-electric md:group-hover:translate-x-3">
                  {artist.name}
                </h3>
      ...
      <div
        ref={previewRef}
        className="pointer-events-none absolute left-0 top-0 z-20 hidden aspect-[4/5] w-[240px] -translate-x-1/2 -translate-y-1/2 overflow-hidden border border-white/10 bg-black opacity-0 lg:block xl:w-[280px]"
      >
        {activeArtist && (
          <>
            <Image
            ...
            <div className="absolute inset-0 bg-forest-light/10 mix-blend-color" />
